...
if (isset($merchant_report_data) && !empty($merchant_report_data) && is_array($merchant_report_data)) : 
	...
	$reports_export_link = $_SERVER["PHP_SELF"] . "?page=rdr2-merchants&action=export-spreadsheet&data=merchant-reports&report=top_40_players&id=" . $id;
?>
...
<form name="merchant-report" id="merchant-report" method="get">
	...
	<input type="hidden" name="ajaxaction" id="ajaxaction" value="_ajax_fetch_merchant_report_top_40_players" />
