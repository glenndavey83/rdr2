...
if (isset($merchant_report_data) && !empty($merchant_report_data)) : 
	...
	/*
	$keys = array_keys($merchant_report_data["Female"][0]);
...
*/?>
<?php if (isset($merchant_report_table_female) && !empty($merchant_report_table_female)) : ?>
	<h3>Female</h3>
	<?php $merchant_report_table_female->display(); ?>
<?php endif; ?>

<?php if (isset($merchant_report_table_male) && !empty($merchant_report_table_male)) : ?>
	<h3>Male</h3>
	<?php $merchant_report_table_male->display(); ?>
<?php endif; ?>

<?php if (isset($merchant_report_table_unknown) && !empty($merchant_report_table_unknown)) : ?>
	<h3>Unknown</h3>
	<?php $merchant_report_table_unknown->display(); ?>
<?php endif; ?>
