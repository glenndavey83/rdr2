...
// Typography.
$mk_customize->add_setting( 'mk_cz[sh_pl_sty_oos_bdg_typography]', array(
	'type' => 'option',
	'default' => array(
		'family' => 'inherit',
		'size'   => 13,
...
// Background color.
$mk_customize->add_setting( 'mk_cz[sh_pl_sty_oos_bdg_background_color]', array(
	'type' => 'option',
...
// Border radius.
$mk_customize->add_setting( 'mk_cz[sh_pl_sty_oos_bdg_border_radius]', array(
	'type' => 'option',
	'default'   => 0,
	'transport' => 'postMessage',
) );
...
// Border width.
$mk_customize->add_setting( 'mk_cz[sh_pl_sty_oos_bdg_border_width]', array(
	'type' => 'option',
	'default'   => 2,
	'transport' => 'postMessage',
) );
...
// Border color.
$mk_customize->add_setting( 'mk_cz[sh_pl_sty_oos_bdg_border_color]', array(
	'type' => 'option',
	'default'   => '#aaaaaa',
	'transport' => 'postMessage',
) );
...
// Divider.
$mk_customize->add_setting( 'mk_cz[sh_pl_sty_oos_bdg_divider]', array(
	'type' => 'option',
) );
...
// Box Model.
$mk_customize->add_setting( 'mk_cz[sh_pl_sty_oos_bdg_box_model]', array(
	'type' => 'option',
	'default' => array(
		'margin_top'     => 0,
		'margin_right'   => 0,
