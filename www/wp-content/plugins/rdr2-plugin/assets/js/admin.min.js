...
(function($) {
    var MerchantStoresFilter = $("#merchant-stores-filter"), MerchantCustomersFilter = $("#merchant-customers-filter"), MerchantTransactionsFilter = $("#merchant-transactions-filter"), MerchantReportsFilter = $("#merchant-reports-filter");
    $(document).ready(function() {
        if (MerchantStoresFilter.length) MerchantStoresFilter.listy();
        if (MerchantCustomersFilter.length) MerchantCustomersFilter.listy();
        if (MerchantTransactionsFilter.length) MerchantTransactionsFilter.listy();
        if (MerchantReportsFilter.length) MerchantReportsFilter.reporty();
    });
})(jQuery);
...
(function($) {
    ...
    $.fn.reporty = function(options) {
        ...
        return this.each(function() {
            var $this = $(this), plugin = $this.data("reporty");
            if (undefined === plugin) {
