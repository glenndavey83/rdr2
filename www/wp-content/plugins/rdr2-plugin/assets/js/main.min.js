...
(function($) {
    $.tracky = function(container, options) {
        var plugin = this, $container = $(container), $app = false, $UpdatingFlag = false, name = "Tracky", slug = "tracky", title = name + " jQuery Plugin", logging = true, logPrefix = name, delay = 2500, defaults = {
            delay: delay,
            Swiper: {
                direction: "horizontal",
                loop: false,
        ...
        }, craftables = JSON.parse(database.craftables), craftable_sources = JSON.parse(database.craftable_sources), craftable_categories = JSON.parse(database.craftable_categories), craftable_groups = JSON.parse(database.craftable_groups), craftable_collectables = JSON.parse(database.craftable_collectables), collectables = JSON.parse(database.collectables), ingredients = JSON.parse(database.ingredients), ingredient_types = JSON.parse(database.ingredient_types), ingredient_qualities = JSON.parse(database.ingredient_qualities), ingredient_parts = JSON.parse(database.ingredient_parts), player_game_crafted = JSON.parse(database.player_game_crafted), player_game_collected = JSON.parse(database.player_game_collected), player_game_submitted = JSON.parse(database.player_game_submitted), content = {
            Screens: [ {
                name: "Source"
            }, {
                name: "IngredientType"
            ...
            App: {
                ...
                get Filters() {
                    return '<div class="' + classes.App.Sections.Filter + '"><ul class="' + classes.List.Horizontal + " " + classes.List.Pill + '"><li><label class=""><input type="checkbox" name="' + name.Filter + '" value="1" id="' + ids.Filters.Remaining + '"> Show remaining only </label></li></ul></div>';
                },
                Sections: '<div class="' + classes.App.Sections.Container + '"><div class="' + classes.App.Sections.Wrapper + ' swiper-wrapper"></div></div>'
            },
            get Dashicon() {
                return !state.Dashicon || !classes.Dashicons[state.Dashicon] ? false : '<span class="' + classes.Dashicon + " " + classes.Dashicons[state.Dashicon] + '"></span>';
            },
            Icon: {
                get Yes() {
                    state.Dashicon = "Yes";
            ...
            get UpdatingFlag() {
                return '<div class="' + classes.UpdatingFlag + '" id="' + ids.UpdatingFlag + '"><span class="' + classes.UpdatingLabel + '">' + content.UpdatingLabel + "</span></div>";
            },
            Sources: {
        ...
        plugin.setupAppScreens = function(data) {
            ...
            $("#" + ids.Filters.Remaining, $container).on(events.Change, function(e) {
                if ($(this).prop(property.Checked) == true) $app.addClass(classes.Filters.Remaining); else $app.removeClass(classes.Filters.Remaining);
            });
        ...
        var showBySource = function(data) {
            ...
            for (var l = 0; l < craftable_sources.length; l++) {
                ...
                for (var c = 0; c < sourceCategories.length; c++) {
                    var categoryGroups = craftable_groups.filter(function(obj) {
                        return obj.Category == sourceCategories[c].ID;
                    }), categoryContent = "";
                    ...
                    for (var g = 0; g < categoryGroups.length; g++) {
                        var groupCraftables = craftables.filter(function(obj) {
                            return obj.Group == categoryGroups[g].ID;
                        }), groupsContent = "";
                        if (!groupCraftables.length) continue;
                        if (categoryGroups[g].Name !== sourceCategories[c].Name) groupsContent += "<ul>";
                        for (var i = 0; i < groupCraftables.length; i++) {
                            ...
                            for (var s = 0; s < craftableCollectables.length; s++) {
                                var collectable = collectables.filter(function(obj) {
                                    return obj.ID == craftableCollectables[s].Collectable;
                                    ...
                                    return obj.Collectable == craftableCollectables[s].Collectable;
                                    ...
                                    return obj.ItemCollectable == craftableCollectables[s].ID;
                                ...
                                for (var q = 0; q < quantity; q++) {
                                    var isCollected = q < quantityCollected, availableVal = isCollected ? classes.Flag.Available : "", isSubmitted = q < quantitySubmitted, checkedVal = isSubmitted ? property.Checked : "", disabledVal = isSubmitted && !isCollected ? classes.Flag.Disabled : "";
                            ...
                            var craftedCraftable = player_game_crafted.filter(function(obj) {
                                return obj.Craftable == groupCraftables[i].ID;
                            })[0], totalRemaining = totalCollectable - totalSubmitted, isSubmittable = totalSubmitted < totalCollectable, isCraftable = !isSubmittable, isCrafted = typeof craftedCraftable !== "undefined" && craftedCraftable.Acquired == 1, abled = isSubmittable ? property.Disabled : "", opened = isSubmittable ? property.Open : "", available = isCraftable ? classes.Flag.Available : "", checkedVal = isCrafted ? property.Checked : "", craftableClass = totalRemaining == 0 ? classes.Flag.Disabled : "";
        ...
        var _setupSourceActions = function(data, $div) {
            ...
            $("." + classes.Collectable.Item.Input, $div).on(events.Change, function(e) {
                ...
                var $checkboxList = $(this).parentsUntil("." + classes.App.Checkbox.List).parent(), $collectableItem = $checkboxList.parentsUntil("details").parent(), $collectableItemSummary = $("summary", $collectableItem), $collectableItemCheckbox = $("label", $collectableItemSummary), $collectableItemCheckboxInput = $("input", $collectableItemCheckbox), unchecked = $("input", $checkboxList).not(":" + property.Checked).length;
                if ($(this).prop(property.Checked)) {
                    $(this).parent().addClass(classes.Checked);
                    if (unchecked) return;
                    $collectableItemSummary.removeClass(classes.Flag.Disabled);
                    $collectableItemCheckbox.removeClass(classes.Flag.Disabled).addClass(classes.Flag.Available);
                    $collectableItemCheckboxInput.prop(property.Disabled, "");
                    return;
                }
                $(this).parent().removeClass(classes.Checked);
                if (unchecked > 1) return;
                $collectableItemSummary.addClass(classes.Flag.Disabled);
                $collectableItemCheckbox.addClass(classes.Flag.Disabled).removeClass(classes.Flag.Available);
                $collectableItemCheckboxInput.prop(property.Disabled, property.Disabled);
            });
            ...
            $("." + classes.Group.Craftable.Checkbox, $div).on(events.Click, function(e) {
                e.preventDefault();
                var $input = $("input", $(this)), checked = $input.prop(property.Checked), availableThis = $(this).hasClass(classes.Flag.Available);
                if (checked == true) {
                    unCheck($input);
                    return;
                }
            ...
            $("." + classes.Group.Craftable.Input, $div).on(events.Change, function(e) {
                ...
                if (checked) $(this).parent().addClass(classes.Flag.Checked); else $(this).parent().removeClass(classes.Flag.Checked);
                activateUpdatingFlag();
                clicked = {
                    craftable: $(this).val(),
        ...
        var showByIngredientType = function(data) {
            ...
            for (var t = 0; t < ingredientTypes.length; t++) {
                ...
                for (var n = 0; n < typeIngredients.length; n++) {
                    var ingredientCollectables = collectables.filter(function(obj) {
                    ...
                    for (var c = 0; c < ingredientCollectables.length; c++) {
                        ...
                        })[0], collectableCraftables = craftable_collectables.filter(function(obj) {
                            return obj.Collectable == ingredientCollectables[c].ID;
                        }), quantity = ingredientCollectables[c].Quality == 2 ? 1 : sumColumn(collectableCraftables, "Quantity"), collectableCollected = player_game_collected.filter(function(obj) {
                            return obj.Collectable == ingredientCollectables[c].ID;
                        })[0], quantityCollected = typeof collectableCollected !== "undefined" ? collectableCollected.Collected : 0;
                        totalCollectable = totalCollectable + parseInt(quantity);
                        totalCollected = totalCollected + parseInt(quantityCollected);
        ...
        var _setupIngredientActions = function(data, $div) {
            $("." + classes.DeadCheckbox, $div).each(function() {
                ...
                $(this).on(events.Click, function(e) {
                    e.preventDefault();
                    var input = $("input", $(this)), collectable = "", checked = input.prop(property.Checked) == true, collectable = input.val(), $source = $("#" + ids.Source.Tabs), $prevCollectable = false;
                    if (checked == true) {
                        ...
                        if (input == next) input.prop(property.Checked, property.Checked).trigger(events.Change); else next.prop(property.Checked, property.Checked).trigger(events.Change);
                        if (!$source.length) return;
                        $collectable = $(classes.Collectable.Input + "[value=" + collectable + "]", $source);
                        if (!$collectable) return;
                        var curItem = false;
                        $collectable.each(function() {
                            if ($(this).parent().hasClass(classes.Flag.Available)) return;
            ...
            $("input", $("." + classes.DeadCheckbox, $div)).on(events.Change, function(e) {
                if ($(this).prop(property.Checked)) $(this).parent().addClass(classes.Checked); else $(this).parent().removeClass(classes.Checked);
            });
        ...
        var updateCraftable = function(data) {
            ...
            var item = data.item, game_id = $("#" + ids.Game).val(), itemCurrent = player_game_crafted.length ? player_game_crafted.filter(function(obj) {
                return obj.Item == item;
            }) : false, ajaxActions = {
                update: "_ajax_update_player_game_craftable",
                insert: "_ajax_insert_player_game_craftable"
            };
            if (typeof state.Interval.Update[item] !== "undefined" && state.Interval.Update[item] !== false) clearInterval(state.Interval.Update[item]);
            var action = "insert";
        ...
        var _submitCollectable = function(data) {
            ...
            var collectable = data.collectable, checked = $("input.collectable[value=" + collectable + "]:" + property.Checked), quantity = checked.length, game_id = $("#game_id").val(), submittedCurrent = player_game_submitted.filter(function(obj) {
            ...
            if (typeof state.Interval.Update[collectable] !== "undefined" && state.Interval.Update[collectable] !== false && state.Interval.Update[collectable] !== null) clearInterval(state.Interval.Update[collectable]);
        ...
        var collectCollectable = function(data) {
            ...
            var collectable = data.collectable, checked = $(".collectable[value=" + collectable + "]:" + property.Checked), quantity = checked.length, game_id = $("#game_id").val(), collectableCurrent = player_game_collected.filter(function(obj) {
                return obj.Collectable == collectable;
            }), ajaxActions = {
                update: "_ajax_update_player_game_collectable",
                insert: "_ajax_insert_player_game_collectable"
            };
            if (typeof state.Interval.Update[collectable] !== "undefined" && state.Interval.Update[collectable] !== false) clearInterval(state.Interval.Update[collectable]);
        ...
        var unCheck = function(element) {
            if (typeof element == "undefined" || !element) return false;
            element.prop(property.Checked, "").trigger(events.Change);
        };
