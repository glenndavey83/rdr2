...
(function($) {
    $.tracky = function(container, options) {
        var plugin = this, $container = $(container), name = "Tracky", title = name + " jQuery Plugin", logging = true, logPrefix = name, delay = 2500, defaults = {
            delay: delay
        }, settings, timer, staticData, navTabActive, locationID, swiper, tabNum = 0, navTabs = "", tabs = "", updateInterval = {}, collection_locations = JSON.parse(database.collection_locations), collections = JSON.parse(database.collections), collection_groups = JSON.parse(database.collection_groups), collection_collectables = JSON.parse(database.collection_collectables), collection_items = JSON.parse(database.collection_items), collection_item_collectables = JSON.parse(database.collection_item_collectables), ingredients = JSON.parse(database.ingredients), ingredient_types = JSON.parse(database.ingredient_types), ingredient_qualities = JSON.parse(database.ingredient_qualities), ingredient_parts = JSON.parse(database.ingredient_parts), player_game_items = JSON.parse(database.player_game_items), player_game_collected = JSON.parse(database.player_game_collected), player_game_submitted = JSON.parse(database.player_game_submitted), content = {
            Screens: [ {
                name: "Location"
            }, {
                name: "IngredientType"
        ...
        var setupScreens = function(data) {
            ...
            $("#filter-remaining", $container).on("change", function(e) {
                if ($(this).prop("checked") == true) $app.addClass("filter-remaining"); else $app.removeClass("filter-remaining");
            });
        ...
        var showByLocation = function(data) {
            var locationIcons = {
                ...
                3: "far fa-envelope",
                4: "fas fa-paw"
            }, heading = "<h3 class='screen-reader-text'>Sources</h3>", navTabs = "";
            for (var l = 0; l < collection_locations.length; l++) {
                ...
                var locationCollections = collections.filter(function(obj) {
                    return obj.Location == collection_locations[l].ID;
                });
                if (locationCollections.length) {
                    for (var c = 0; c < locationCollections.length; c++) {
                        var detailsContent = "";
                        var collectionGroups = collection_groups.filter(function(obj) {
                            return obj.Collection == locationCollections[c].ID;
                        });
                        if (collectionGroups.length) {
                            ...
                            for (var g = 0; g < collectionGroups.length; g++) {
                                var itemsContent = "";
                                var groupItems = collection_items.filter(function(obj) {
                                    return obj.Group == collectionGroups[g].ID;
                                });
                                if (groupItems.length) {
                                    if (collectionGroups[g].Name !== locationCollections[c].Name) itemsContent += "<ul>";
                                    for (var i = 0; i < groupItems.length; i++) {
                                        ...
                                        var itemCollectables = collection_item_collectables.filter(function(obj) {
                                            return obj.Item == groupItems[i].ID;
                                        });
                                        if (itemCollectables.length) {
                                            ...
                                            for (var s = 0; s < itemCollectables.length; s++) {
                                                var collectionCollectable = collection_collectables.filter(function(obj) {
                                                    return obj.ID == itemCollectables[s].Collectable;
                                                })[0], ingredient = ingredients.filter(function(obj) {
                                                    return obj.ID == collectionCollectable.Ingredient;
                                                })[0], quality = ingredient_qualities.filter(function(obj) {
                                                    return obj.ID == collectionCollectable.Quality;
                                                })[0], part = ingredient_parts.filter(function(obj) {
                                                    return obj.ID == collectionCollectable.Part;
                                                })[0], quantity = itemCollectables[s].Quantity, collectedCollectable = player_game_collected.filter(function(obj) {
                                                    return obj.Collectable == itemCollectables[s].Collectable;
                                                })[0], submittedCollectable = player_game_submitted.filter(function(obj) {
                                                    return obj.ItemCollectable == itemCollectables[s].ID;
                                                })[0], quantityCollected = typeof collectedCollectable !== "undefined" ? collectedCollectable.Collected : 0, quantitySubmitted = typeof submittedCollectable !== "undefined" ? submittedCollectable.Quantity : 0, collectablesContent = "";
                                                ...
                                                for (var q = 0; q < quantity; q++) {
                                                    var isSubmitted = q < quantitySubmitted, isCollected = q < quantityCollected, availableVal = isCollected ? "available " : "", checkedVal = isSubmitted ? "checked " : "", disabledVal = isSubmitted && !isCollected ? "disabled " : "";
                                        ...
                                        var submittable = totalSubmitted < totalCollectable, craftable = !submittable, craftedItem = player_game_items.filter(function(obj) {
                                            return obj.Item == groupItems[i].ID;
                                        })[0], isCrafted = typeof craftedItem !== "undefined" && craftedItem.Acquired == 1, abled = submittable ? "disabled " : "", opened = submittable ? " open " : "", available = craftable ? "available " : "", checkedVal = isCrafted ? "checked " : "", frank;
        ...
        var _setupLocationActions = function(data, $div) {
            ...
            $(".item-collectable-checkbox", $div).on("click", function(e) {
                e.preventDefault();
                var $input = $("input", $(this)), item = "", checked = $input.prop("checked"), $all = $(this).parent().children(), $siblings = $(this).siblings(), $sold = $("input:checked", $(this).parent()).parent(), $notSold = $("input", $all).not(":checked").parent(), $available = $(".available", $(this).parent()), $availableAny = $(this).siblings(".available"), $availableAnyNotSold = $("input", $availableAny).not(":checked").parent(), $availableNotSold = $("input", $available).not(":checked").parent(), $notAvailableNotSold = $notSold.not(".available"), availableAny = $availableAnyNotSold.length > 0, availableThis = $(this).hasClass("available"), collectable = $input.val();
                if (checked == true) {
                ...
                if (!confirm("This item has not been collected. Do you want to mark as collected and sell?")) return;
            ...
            $("input", $(".item-collectable-checkbox", $div)).on("change", function(e) {
                ...
                var $checkboxList = $(this).parentsUntil(".app-checkbox-list").parent(), $collectableItem = $checkboxList.parentsUntil("details").parent(), $collectableItemSummary = $("summary", $collectableItem), $collectableItemCheckbox = $("label", $collectableItemSummary), $collectableItemCheckboxInput = $("input", $collectableItemCheckbox), unchecked = $("input", $checkboxList).not(":checked").length;
                if ($(this).prop("checked")) {
                    $(this).parent().addClass("checked");
                    log(unchecked);
                    if (unchecked) return;
                    $collectableItemSummary.removeClass("disabled");
                    $collectableItemCheckbox.removeClass("disabled").addClass("available");
                    $collectableItemCheckboxInput.prop("disabled", "");
                    return;
                }
                $(this).parent().removeClass("checked");
                if (unchecked > 1) return;
                $collectableItemSummary.addClass("disabled");
                $collectableItemCheckbox.addClass("disabled").removeClass("available");
                $collectableItemCheckboxInput.prop("disabled", "disabled");
            });
            ...
            $(".collectable-item-checkbox", $div).on("click", function(e) {
                e.preventDefault();
                var $input = $("input", $(this)), item = "", checked = $input.prop("checked"), availableThis = $(this).hasClass("available"), frank;
                if (checked == true) {
                    unCheck($input);
                    return;
                }
            ...
            $("input", $(".collectable-item-checkbox", $div)).on("change", function(e) {
                ...
                if (checked) $(this).parent().addClass("checked"); else $(this).parent().removeClass("checked");
                activateUpdatingFlag();
                clicked = {
                    item: $(this).val(),
        ...
        var showByIngredientType = function(data) {
            var typeIcons = {
                ...
                4: "far fa-gem",
                5: "far fa-snowflake"
            }, heading = "<h3 class='screen-reader-text'>Collectables</h3>", navTabs = "", remaining = [];
            for (var t = 0; t < ingredient_types.length; t++) {
                ...
                var typeIngredients = ingredients.filter(function(obj) {
                    return obj.Type == ingredient_types[t].ID;
                });
                if (typeIngredients.length) {
                    for (var n = 0; n < typeIngredients.length; n++) {
                        var collectionCollectables = collection_collectables.filter(function(obj) {
                            return obj.Ingredient == typeIngredients[n].ID;
                        }), ingredientsContent = "", detailsContent = "", totalCollectable = 0, totalCollected = 0, totalSubmitted = 0;
                        for (var c = 0; c < collectionCollectables.length; c++) {
                            var ingredient = ingredients.filter(function(obj) {
                                return obj.ID == collectionCollectables[c].Ingredient;
                            }), part = ingredient_parts.filter(function(obj) {
                                return obj.ID == collectionCollectables[c].Part;
                            })[0], quality = ingredient_qualities.filter(function(obj) {
                                return obj.ID == collectionCollectables[c].Quality;
                            })[0], collectableItems = collection_item_collectables.filter(function(obj) {
                                return obj.Collectable == collectionCollectables[c].ID;
                            }), quantity = collectionCollectables[c].Quality == 2 ? 1 : sumColumn(collectableItems, "Quantity"), collectedCollectable = player_game_collected.filter(function(obj) {
                                return obj.Collectable == collectionCollectables[c].ID;
                            })[0], quantityCollected = typeof collectedCollectable !== "undefined" ? collectedCollectable.Collected : 0;
                            totalCollectable = totalCollectable + parseInt(quantity);
                            totalCollected = totalCollected + parseInt(quantityCollected);
                            totalRemaining = totalCollectable - totalCollected;
                            var remainingObject = {
                                Collectable: collectionCollectables[c].ID,
        ...
        var _setupIngredientActions = function(data, $div) {
            $(".DeadCheckbox", $div).each(function() {
                ...
                $(this).on("click", function(e) {
                    e.preventDefault();
                    var input = $("input", $(this)), collectable = "", checked = input.prop("checked") == true, collectable = input.val(), $location = $("#location-tabs"), $prevCollectable = false;
                    if (checked == true) {
                        $("input:checked", $(this).parent()).last().prop("checked", "").trigger("change");
                        ...
                        if (input == next) input.prop("checked", "checked").trigger("change"); else next.prop("checked", "checked").trigger("change");
                        if (!$location.length) return;
                        $collectable = $("input.itemcollectable[value=" + collectable + "]", $location);
                        if (!$collectable) return;
                        var curItem = false;
                        $collectable.each(function() {
                            if ($(this).parent().hasClass("available")) return;
        ...
        var updateRemaining = function($el, remaining) {
            ...
            } else $details.removeClass("disabled");
        ...
        var unCheck = function(element) {
            element.prop("checked", "").trigger("change");
        };
        ...
        var updateItem = function(data) {
            ...
            var item = data.item, game_id = $("#game_id").val(), itemCurrent = player_game_items.length ? player_game_items.filter(function(obj) {
                return obj.Item == item;
            }) : false, ajaxActions = {
                update: "_ajax_update_player_game_item",
                insert: "_ajax_insert_player_game_item"
            };
            if (typeof updateInterval[item] !== "undefined" && updateInterval[item] !== false) clearInterval(updateInterval[item]);
            var action = "insert";
            if (itemCurrent.length) var action = "update";
            extra = {
            ...
            updateInterval[item] = setTimeout(function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (updatedLocally == false && player_game_items !== false) player_game_items.push({
                            Item: data.item,
        ...
        var _updateItemCollectable = function(data) {
            ...
            var itemcollectable = data.itemcollectable, checked = $("input.itemcollectable[value=" + itemcollectable + "]:checked"), quantity = checked.length, game_id = $("#game_id").val(), submittedCurrent = player_game_submitted.filter(function(obj) {
                return obj.ItemCollectable == itemcollectable;
            })[0], ajaxActions = {
                update: "_ajax_update_player_game_item_collectable",
                insert: "_ajax_insert_player_game_item_collectable"
            };
            if (typeof updateInterval[itemcollectable] !== "undefined" && updateInterval[itemcollectable] !== (false || null)) clearInterval(updateInterval[itemcollectable]);
            if (!submittedCurrent) var action = "insert"; else {
                var action = "update";
        ...
        var updateCollectable = function(data) {
            ...
            var collectable = data.collectable, checked = $(".collectable[value=" + collectable + "]:checked"), quantity = checked.length, game_id = $("#game_id").val(), collectableCurrent = player_game_collected.filter(function(obj) {
                return obj.Collectable == collectable;
            }), ajaxActions = {
                update: "_ajax_update_player_game_collectable",
                insert: "_ajax_insert_player_game_collectable"
            };
            if (typeof updateInterval[collectable] !== "undefined" && updateInterval[collectable] !== false) clearInterval(updateInterval[collectable]);
            ...
            updateInterval[collectable] = setTimeout(function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (updatedLocally == false) player_game_collected.push({
    ...
    $.tippy = function(container, options) {
        ...
        plugin.update = function(response) {
            setTimeout(function() {
                ...
                $section.html("<p>" + response[responseNumber].Description + "</p>").removeClass("updating");
            }, 300);
        };
        plugin.publicMethods = {};
