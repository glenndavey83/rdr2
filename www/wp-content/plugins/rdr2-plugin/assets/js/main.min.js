...
(function($) {
    $(document).ready(function() {
        var GamesPortalContainer = $("#PlayerGamesPortal"), ItemsPortalContainer = $("#PlayerItemsPortal"), RandomTip = $("#RandomTip"), $tabsContainer = $(".luckytabs");
        ...
        if (ItemsPortalContainer.length) ItemsPortalContainer.itemizely();
        if (GamesPortalContainer.length) GamesPortalContainer.filtery();
        if (RandomTip.length) RandomTip.tippy();
    });
    (function($) {
        $.itemizely = function(container, options) {
            var plugin = this, $container = $(container);
            var settings, timer, delay, staticData, navTabActive, locationID, tabNum = 0, delay = 2500, navTabs = "", tabs = "", updateInterval = {}, updatingFlag = "<div class='updating-flag'><span class='updating-label'>Updating...</span></div>";
            var defaults = {
                delay: delay
            };
                                        ...
                                        for (var i = 0; i < groupItems.length; i++) {
                                            ...
                                            if (itemCollectables.length) {
                                                ...
                                                for (var s = 0; s < itemCollectables.length; s++) {
                                                    ...
                                                    var quality = ingredient_qualities.filter(function(obj) {
                                                        return obj.ID == collectionCollectable.Quality;
                                                    })[0];
                                                    var part = ingredient_parts.filter(function(obj) {
            ...
            var updateCollectable = function(data) {
                ...
                var collectableCurrent = player_game_collected.filter(function(obj) {
        ...
        $.fn.itemizely = function(options) {
            ...
            return this.each(function() {
                var $this = $(this), plugin = $this.data("itemizely");
                if (undefined === plugin) {
    ...
    (function($) {
        $.filtery = function(container, options) {
            var plugin = this, $container = $(container);
            var settings, timer, delay, staticData, navTabActive, locationID, tabNum = 0, delay = 1500, navTabs = "", tabs = "", updateInterval = {}, updatingFlag = "<div class='updating-flag'><span class='updating-label'>Updating...</span></div>";
            var defaults = {
                delay: 2500
            };
            plugin.init = function() {
                    ...
                    if (typeIngredients.length) {
                        for (var n = 0; n < typeIngredients.length; n++) {
                            ...
                            for (var c = 0; c < collectionCollectables.length; c++) {
                                ...
                                var collectableItems = collection_item_collectables.filter(function(obj) {
                                ...
                                var collectedCollectable = player_game_collected.filter(function(obj) {
                                    return obj.Collectable == collectionCollectables[c].ID;
                                })[0];
            ...
            var updateCollectables = function(data) {
                if (updateInterval !== false) clearInterval(updateInterval);
                var formResults = $("#collectables-filter").serializeArray();
                var game_id = $("#game_id").val();
                var collectables = formResults.filter(function(obj) {
        ...
        $.tippy = function(container, options) {
            ...
            plugin.update = function(response) {
                setTimeout(function() {
                    ...
                    $container.html("<p>" + response[responseNumber].Description + "</p>").removeClass("updating");
                }, 300);
            };
            plugin.publicMethods = {};
    ...
    function setupTabs(tabElement) {
        if (tabElement.length) {
            ...
            $(window).on("hashchange", function() {
                ...
                if (hashslice.length > 0 && $("#" + hashslice, tabElement).length) tabElement.easytabs("select", hashslice);
            });
        }
    }
