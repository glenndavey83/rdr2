...
class CleanLogin_Controller{
    ...
    static function get_edit_url(){
        ...
        if( function_exists('cl_edit_id') ) {
            $edit_id = apply_filters( 'wpml_object_id', $login_id, 'page', FALSE, ICL_LANGUAGE_CODE );
        }        

        return get_permalink( $edit_id );
    }
    ...
    static function get_restore_password_url(){
        ...
        return get_permalink( $restore_id );
    }
    ...
    static function get_register_url(){
        ...
        return get_permalink( $register_id );
    }
